/* N.B. Read the following to understand lb-services and Angular SDK
 * 
 * https://docs.strongloop.com/display/public/LB/Create+AngularJS+client#CreateAngularJSclient-IntroducingtheAngularJSSDK
 * https://docs.strongloop.com/display/public/LB/AngularJS+JavaScript+SDK
 * 
 * The lb-ng tool does the "heavy lifting" of creating the client JavaScript API that works with your LoopBack back-end. 
 * However, you still need to create the HTML/CSS and client 
 * JavaScript code that actually calls into this AngularJS API and defines the client-side 
 * functionality and appearance of your app. In general, creating this part of the app is entirely up to you
 */
